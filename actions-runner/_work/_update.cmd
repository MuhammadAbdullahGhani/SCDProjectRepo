...
set rootfolder=C:\E\Semester 6\SCD\app\actions-runner
set existrunnerversion=2.308.0
set downloadrunnerversion=2.323.0
set logfile=C:\E\Semester 6\SCD\app\actions-runner\_diag\SelfUpdate-20250512-134800.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "C:\E\Semester 6\SCD\app\actions-runner\run.cmd"
) else (
  endlocal
)
